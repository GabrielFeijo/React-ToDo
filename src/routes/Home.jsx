				...
				<div className='home-box '>
					...
					<div className='image'>
						...
						<p className='description'>
							Um gerenciador de tarefas simples e prático. Com esta aplicação
							você pode cadastrar suas tarefas e quando finalizar poderá
							marca-lá como concluída.
						</p>
					</div>
				</div>
			) : (
